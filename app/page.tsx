  ...
  return (
    <div className="space-y-5 px-4 pt-8 pb-8">
      ...
      <div className="flex gap-2 overflow-x-auto text-sm">
        ...
        <Link href="/retirement-planning" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          退休規劃
        </Link>
        <Link href="/basic-living-deduction" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          免稅天花板
        </Link>
        ...
        <Link href="/dependent-deduction" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          扶養節稅
        </Link>
        <Link href="/freelancer-tax-guide" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          接案報稅
        </Link>
        <Link href="/side-income-tax" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          副業所得申報
        </Link>
        <Link href="/tax-strategy-2026" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          省稅策略
        </Link>
        <Link href="/supplement-premium" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          二代健保
        </Link>
        ...
        <Link href="/gift-tax" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          贈與稅
        </Link>
        <Link href="/stock-tax-2026" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          投資稅務
        </Link>
        <Link href="/amt-calculator" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          最低稅負
        </Link>
        ...
        <Link href="/etax-guide-2026" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1.5 font-medium text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          eTax教學
        </Link>
        <Link
