  ...
  return (
    <div className="min-h-screen pb-10">
      ...
      <div className="flex gap-2 overflow-x-auto bg-white px-4 pt-4 pb-2 text-sm">
        ...
        <Link href="/retirement-planning" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1 text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          退休規劃
        </Link>
        ...
        <Link href="/labor-insurance-rates" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1 text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          勞健保費率
        </Link>
        ...
        <Link href="/freelancer-tax-guide" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1 text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          接案報稅
        </Link>
        <Link href="/side-income-tax" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1 text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          副業所得申報
        </Link>
        <Link href="/tax-strategy-2026" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1 text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          省稅策略
        </Link>
        ...
        <Link href="/supplement-premium" className="whitespace-nowrap rounded-full border border-gray-200 px-3 py-1 text-gray-600 hover:border-blue-400 hover:text-blue-600 transition">
          二代健保
        </Link>
