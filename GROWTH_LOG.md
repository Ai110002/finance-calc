...
- **流量**：網路無法存取；5月1日報稅開放前 ≈ 14 天（最後黃金窗口）
- **前次備注確認**：session 63 完成 /insurance-deduction-2026 + /mortgage-interest-deduction-2026 + 4篇 Threads。本次執行 session 63 列出的下一步：`/medical-deduction-2026`。

### 今天做了什麼

#### 1. 新頁面：`/medical-deduction-2026`（醫藥及生育費列舉扣除額完整攻略）

**為什麼做這個**：
全站沒有任何頁面覆蓋「醫藥費報稅」「醫療費用抵稅」關鍵字。
醫藥及生育費是所有列舉扣除項目中唯一沒有金額上限的，高意圖搜尋量高。
最關鍵賣點：①無金額上限；②只有保險理賠後的自付部分才能申報；③幫扶養親屬付的醫療費也可申報。
「父母住院費可以報稅嗎」「保險理賠後自付部分能申報嗎」是高頻疑問。
補全列舉扣除額系列最後缺口，與 /insurance-deduction-2026、/ltc-deduction-2026 形成「重病家庭節稅三角」。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是醫藥及生育費列舉扣除額 | 無上限、只申報自付額、必須選列舉 |
| 章節2 | 哪些費用可以申報 | 掛號/手術/住院/生育/中醫可以；健檢/坐月子/美容不行 |
| 章節3 | 能省多少稅 | 三個情境試算（癌症治療60萬、一般上班族、生育）|
| 章節4 | 特殊情況說明 | 差額病床費/月子中心/看護費/海外就醫 |
| 章節5 | eTax申報步驟 | 手動輸入、收據正本保存5年 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/insurance-deduction-2026、/ltc-deduction-2026、/disability-deduction-2026 等）

**SEO 關鍵字覆蓋（12個）**：
醫藥費列舉扣除、醫療費用報稅、醫藥費抵稅、看診費用可以報稅嗎、住院費報稅、生育費扣除額、114年醫療費扣除、醫藥費節稅2026、醫療費用扣除額、手術費報稅、醫藥費申報、醫療費列舉2026

#### 2. Sitemap 更新
- 新增 `/medical-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-17T10:00:00Z）

#### 3. Threads 草稿 × 4（醫藥費 + 今日固定排程）
**`public/threads-drafts/2026-04-17-medical-deduction.md`**

| 草稿 | 角度 | 核心鉤子 | 建議發布日 |
|---|---|---|---|
| A（醫藥費無上限但搞錯了版） | 「只有自付部分才能報」 | 「保險理賠的部分不能算，很多人把全額都報了」 | 4/17 晚上7點 |
| B（爸媽住院費可省稅版） | 扶養親屬醫療費 | 「媽媽住院自付30萬 × 20% = 省6萬，法條有寫」 | 4/18 早上9點 |
| C（大學學費固定排程版） | session 62 草稿A重發 | 「選標準扣除額也可以一起用25,000」 | 4/17 早上9點 |
| D（保險費抵稅固定排程版） | session 63 草稿A重發 | 「全民健保費另外算無上限」 | 4/17 中午12點 |

**Build 狀態**：node_modules 不存在（本地無法 build）→ Server Component、無 hooks，結構與現有頁面完全一致，push 至 Vercel 遠端 build 驗證

### 預期營收影響
- **新頁面 /medical-deduction-2026**：
  - 台灣老年化，照顧父母的家庭數百萬，「父母住院費可以報稅嗎」是高頻搜尋
  - 「無金額上限」+ 「只有自付部分」兩個反直覺資訊，分享動機強
  - 與 /insurance-deduction-2026、/ltc-deduction-2026 強內連（重病家庭完整節稅漏斗）
  - 保守估計 5 月帶入額外 400~800 訪客
- **Threads 4篇**：
  - 草稿B「媽媽住院省6萬」= 具體金額 + 家庭情感，分享動機高
  - 估計觸及 1,000~3,000 / 篇，帶入 80~200 訪客

### 下次要做的事（優先順序）
1. **[阻斷] Ian 設定 Vercel env `NEXT_PUBLIC_ADSENSE_SLOT`** — 廣告收入從 0 到有的關鍵
2. **[阻斷] Ian 申請 Money101 聯盟帳號** — CTA 等真實連結
3. **[立即] Ian 發 Threads 文**（按排程）：
   - 4/17 早上9點：大學子女爸媽漏報的25,000元（session 62 草稿 A）
   - 4/17 中午：保費可以抵稅但很多人忘了申報（session 63 草稿）
   - 4/17 晚上：醫藥費無上限但搞錯了（本次草稿 A）
   - 4/18 早上9點：房貸利息公式衝擊版（session 63 草稿 A）
   - 4/18 早上：爸媽住院費可省稅（本次草稿 B）
   - 4/20：3個爸媽常漏報扣除額（session 62 草稿 C）
   - 4/21：廟宇捐款迷思版（session 59 草稿）
4. **下次考慮的新頁面**：
   - `/disaster-deduction-2026`（災害損失列舉扣除，颱風/地震損失，台灣天災多，搜尋量有但較小眾）
   - 或：用 SEO 工具確認哪個關鍵字缺口最大再補（列舉扣除額系列已幾乎完整）
   - 或：轉換率優化（在高流量頁面加強 CTA 點擊率）
...
- **AdSense**：`NEXT_PUBLIC_ADSENSE_SLOT` 仍未設定 → **[阻斷] Ian 需要在 Vercel 後台設定**
- **聯盟行銷**：Money101 links 仍是 placeholder → **[阻斷] Ian 需申請聯盟帳號**
- **流量**：網路無法存取；5月1日報稅開放前 ≈ 15 天（最後黃金窗口）
- **前次備注確認**：session 62 完成 /tuition-deduction-2026 + 3篇 Threads。本次執行 session 62 列出的下一步：`/insurance-deduction-2026` + `/mortgage-interest-deduction-2026`。

### 今天做了什麼

#### 1. 新頁面：`/insurance-deduction-2026`（人身保險費列舉扣除額完整攻略）

**為什麼做這個**：
全站沒有任何頁面覆蓋「保險費抵稅」「人身保險費列舉扣除」關鍵字。
台灣幾乎人人有保險，但很多人不知道保費可列舉扣除（每人24,000）。
關鍵反直覺點：全民健保費無上限另外算，很多人以為健保費就是那24,000。
「保費選列舉還是標準哪個划算」是高搜尋意圖，自然和保費＋房貸＋其他列舉項目聯動。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是人身保險費列舉扣除額 | 每人24,000、健保費另算無上限、必須選列舉 |
| 章節2 | 哪些保險費可以申報 | 壽險/健康險/傷害險可以、車險/火險不行 |
| 章節3 | 能省多少稅 | 各稅率試算、4人家庭最高96,000 |
| 章節4 | 列舉vs標準如何決定 | 保費+健保+房貸+捐款加總比較 |
| 章節5 | eTax申報步驟 | 切換列舉、手動輸入人身保費、確認健保費帶入 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/deduction-compare、/mortgage-interest-deduction-2026 等）

**SEO 關鍵字覆蓋（12個）**：
人身保險費扣除額、保險費列舉扣除、壽險抵稅、健康險報稅、保險費報稅、114年保險費扣除、保險費列舉扣除2026、人身保險報稅、保費抵稅、健保費報稅、保險費所得稅、保險費節稅2026

#### 2. 新頁面：`/mortgage-interest-deduction-2026`（自用住宅購屋借款利息完整攻略）

**為什麼做這個**：
全站沒有任何頁面覆蓋「房貸利息抵稅」「購屋借款利息扣除額」關鍵字族群。
台灣有房貸的家庭數百萬，每年5月都在搜尋「房貸利息可以報稅嗎」。
最關鍵賣點：「可申報金額 = 利息 - 儲蓄投資特別扣除額」這個規定，99%有房貸的人都不知道，容易引起分享。
此頁面與 /savings-deduction-2026、/insurance-deduction-2026、/deduction-compare 強烈聯動。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是自用住宅借款利息扣除額 | 上限30萬、計算公式、必須選列舉 |
| 章節2 | 哪些人可以申報 | 自用/限一戶/借款人本人/必須選列舉 |
| 章節3 | 實際可扣金額怎麼算 | 三個情境完整範例（含儲蓄投資扣除額影響） |
| 章節4 | 房貸利息vs房租：不能同時 | 有房貸選利息、租屋族選房租 |
| 章節5 | eTax申報步驟 | 取得銀行利息對帳單、填入、系統自動計算 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/mortgage、/savings-deduction-2026、/insurance-deduction-2026 等）

**SEO 關鍵字覆蓋（12個）**：
房貸利息扣除額、自用住宅借款利息、房貸利息抵稅、購屋借款利息列舉、房貸利息報稅、114年房貸利息扣除、房貸利息節稅2026、自用住宅貸款利息、房貸抵稅、房屋貸款利息扣除、房貸列舉扣除、購屋利息節稅

#### 3. Sitemap 更新
- 新增 `/insurance-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-16T12:00:00Z）
- 新增 `/mortgage-interest-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-16T12:30:00Z）

#### 4. Threads 草稿 × 4（保費 + 房貸利息）
- `public/threads-drafts/2026-04-16-insurance-deduction.md`（2篇：草稿A漏申報版、草稿B有房貸+保費列舉合算版）
- `public/threads-drafts/2026-04-16-mortgage-interest-deduction.md`（2篇：草稿A公式衝擊版、草稿B倒數15天緊急版）

**Build 狀態**：node_modules 不存在（本地無法 build）→ Server Component、無 hooks，結構與現有頁面完全一致，push 至 Vercel 遠端 build 驗證

### 預期營收影響
- **新頁面 /insurance-deduction-2026**：
  - 台灣幾乎人人有保險，報稅季「保費可以抵稅嗎」是高頻搜尋
  - 「車險不算、健保費無上限」反直覺資訊，分享動機高
  - 與 /deduction-compare、/mortgage-interest-deduction-2026 強內連，形成列舉扣除額完整漏斗
  - 保守估計 5 月帶入額外 400~700 訪客
- **新頁面 /mortgage-interest-deduction-2026**：
  - 台灣有房貸家庭數百萬，高意圖關鍵字
  - 「可申報金額要先扣儲蓄投資扣除額」= 反直覺規則，高分享率
  - 與 /mortgage（房貸計算）強內連，已有流量的頁面導入
  - 保守估計 5 月帶入額外 500~900 訪客
- **Threads 4篇**：
  - 「公式衝擊」版（房貸28萬 - 15萬 = 只剩13萬）分享動機強
  - 估計觸及 1,000~3,000 / 篇，帶入 80~200 訪客
...
2. **[阻斷] Ian 申請 Money101 聯盟帳號** — CTA 等真實連結
3. **[立即] Ian 發 Threads 文**（按排程）：
   - 4/17：大學子女爸媽漏報的25,000元（session 62 草稿 A）
   - 4/17：保費可以抵稅但很多人忘了申報（session 63 草稿 A）
   - 4/18：15天倒數清單（session 62 草稿 B）
   - 4/18：房貸利息公式衝擊版（session 63 草稿 A）
   - 4/20：3個爸媽常漏報扣除額（session 62 草稿 C）
   - 4/21：廟宇捐款迷思版（session 59 草稿）
4. **下次考慮的新頁面**：
   - `/medical-deduction-2026`（醫藥及生育費列舉扣除，無上限但需憑據，搜尋量大）
   - 或 SEO 分析：用流量工具確認哪個關鍵字缺口最大再補
...
- **聯盟行銷**：Money101 links 仍是 placeholder → **[阻斷] Ian 需申請聯盟帳號**
- **流量**：網路無法存取；5月1日報稅開放前 ≈ 15 天（最後黃金窗口）
- **前次備注確認**：session 61 完成 /disability-deduction-2026 + /ltc-deduction-2026 + 3篇 Threads。本次補上全站唯一缺口「教育學費特別扣除額」。

### 今天做了什麼

#### 1. 新頁面：`/tuition-deduction-2026`（教育學費特別扣除額完整攻略）

**為什麼做這個**：
全站 60+ 頁面，從未有任何頁面覆蓋「教育學費特別扣除額」「子女大學學費報稅」關鍵字族群。
台灣大學生約 100 萬人，父母每年 5 月都在搜尋「學費可以報稅嗎」「學費抵稅」。
最關鍵的賣點：這是「特別扣除額」，選標準扣除額也可以同時申報——多數父母不知道，白白漏報。
「選了標準扣除額還可以用嗎」= 高疑問意圖搜尋，容易形成分享。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是教育學費特別扣除額 | 每人25,000、特別扣除額可疊加、不跟列舉/標準衝突 |
| 章節2 | 哪些人可以申報 | 國內大專以上受扶養子女、海外不適用、各種就讀型態說明 |
| 章節3 | 能省多少稅 | 各稅率省稅表、2個子女節稅加倍計算 |
| 章節4 | 學費扣除額 vs 幼兒學前扣除額 | 兩者不重疊、國中高中空白期說明 |
| 章節5 | eTax申報3步驟 | 確認受扶養→確認帶入→異常時如何處理 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/tax-calculator、/preschool-deduction、/disability-deduction-2026 等）

**SEO 關鍵字覆蓋（12個）**：
教育學費特別扣除額、學費可以報稅嗎、學費抵稅、子女教育扣除額、大學學費報稅、114年學費扣除、教育扣除額2026、學費節稅、子女學費申報、大學學費抵稅、研究所學費報稅、教育學費扣除2026

#### 2. Sitemap 更新
- 新增 `/tuition-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-16T10:00:00Z）

#### 3. Threads 草稿 × 3（教育學費 + 15天倒數主題）
**`public/threads-drafts/2026-04-16-tuition-deduction.md`**

| 草稿 | 角度 | 核心鉤子 | 建議發布日 |
|---|---|---|---|
| A（大學子女爸媽漏報版） | 「不知道白白損失25,000」 | 「選標準扣除額也可以一起用，很多父母不知道」 | 4/16 今天 |
| B（15天倒數清單版） | 緊迫感 | 「5月1日倒數15天，現在做5件事」 | 4/17 |
| C（3個爸媽常漏報扣除額版） | 育兒家庭綜合節稅 | 「學費+幼兒學前+身障，3個疊加，最多省超多」 | 4/20 |

**Build 狀態**：node_modules 不存在（本地無法 build）→ Server Component、無 hooks，結構與現有頁面完全一致，push 至 Vercel 遠端 build 驗證

### 預期營收影響
- **新頁面 /tuition-deduction-2026**：
  - 台灣大學生 100 萬人，父母每年報稅季都在搜尋「學費可以報稅嗎」
  - 「選標準扣除額也能用」是反直覺資訊，分享率高
  - FAQ JSON-LD → 富文本搜尋 → CTR 提升 20~40%
  - 含 /preschool-deduction、/disability-deduction-2026 強內連（扶養子女完整漏斗）
  - 保守估計 5 月帶入額外 300~600 訪客（有大學生子女的父母，高意圖）
- **Threads 3篇**：
  - 草稿 A「漏報25,000」= 損失感強，分享動機高（家長轉發給另一半）
  - 草稿 B「15天倒數」= 時效性強，現在發效果最好
  - 預估觸及 1,000~3,000 / 篇，帶入 80~200 訪客

### 下次要做的事（優先順序）
1. **[阻斷] Ian 設定 Vercel env `NEXT_PUBLIC_ADSENSE_SLOT`** — 廣告收入從 0 到有的關鍵
2. **[阻斷] Ian 申請 Money101 聯盟帳號** — CTA 等真實連結
3. **[立即] Ian 發 Threads 文**（按排程）：
   - 4/16 今天：大學子女爸媽漏報的25,000元（草稿 A，本次新建）
   - 4/17：15天倒數清單（草稿 B，本次新建）
   - 4/18：存款利息27萬免稅版（session 60 草稿）
   - 4/20：3個爸媽常漏報扣除額（草稿 C，本次新建）
   - 4/21：廟宇捐款迷思版（session 59 草稿）
   - 4/24：捐款省稅金額實測版（session 59 草稿）
   - 4/25：上班族扣除額地圖版（session 60 草稿）
4. **下次考慮的新頁面**：
   - `/insurance-deduction-2026`（人身保險費列舉扣除額，每人24,000，與學費一樣常被忽略）
   - `/mortgage-interest-deduction-2026`（自用住宅購屋借款利息，最高30萬，搜尋量大）
...
- **前次備注確認**：session 60 已完成 `/savings-deduction-2026` + `/salary-deduction-2026` 兩個新頁面 + Threads 草稿×3。本次執行 session 60 列出的下一步：`/disability-deduction-2026` + `/ltc-deduction-2026` 兩個新頁面。

### 今天做了什麼

#### 1. 新頁面：`/disability-deduction-2026`（身心障礙特別扣除額完整攻略）

**為什麼做這個**：
全站沒有任何頁面覆蓋「身心障礙特別扣除額」「重大傷病卡報稅」關鍵字族群。
台灣約 120 萬人持有身障手冊，加上重大傷病卡持有人，潛在搜尋量龐大。
多數人不知道「不分障礙等級都是 21.8 萬」、也不知道「扶養親屬有身障也可以申報」。
「重大傷病卡可以抵稅嗎」「身心障礙報稅怎麼申報」是常年被問的問題。
22 天被 Google 索引黃金窗口。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是身心障礙特別扣除額 | 每人21.8萬、身障手冊/重大傷病卡、不分等級 |
| 章節2 | 哪些人可以申報 | 本人/配偶/受扶養親屬各自計算、有效期限判斷 |
| 章節3 | 能省多少稅 | 各稅率省稅表、薪資+身障雙扣除積累效果 |
| 章節4 | 身障 vs 長照扣除額 | 同一人只能擇一、稅率20%以上只能用身障 |
| 章節5 | eTax申報3步驟 | 確認成員→確認帶入→送出 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/tax-calculator、/ltc-deduction-2026、/dependent-deduction 等）

**SEO 關鍵字覆蓋（12個）**：
身心障礙特別扣除額、身障扣除額、重大傷病卡報稅、身心障礙報稅、身心障礙所得稅扣除、114年身心障礙扣除、身障扣除2026、身心障礙手冊報稅、身障報稅、重大傷病申報所得稅、身障扶養扣除、身心障礙特別扣除2026

#### 2. 新頁面：`/ltc-deduction-2026`（長期照顧特別扣除額完整攻略）

**為什麼做這個**：
全站沒有任何頁面覆蓋「長期照顧特別扣除額」「外籍看護報稅」關鍵字族群。
台灣高齡化加速，長照需求急增，但多數照顧者不知道有這個扣除額。
「排富條款」是容易踩雷的點（稅率20%以上不能用），製造「原來我不能用」的反差感，分享率高。
外籍看護持有人超過 25 萬人，每年5月都在搜尋相關報稅知識。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是長照特別扣除額 | 每人12萬、三種適用情況 |
| 章節2 | 排富條款（最重要） | 稅率20%不得申報、選28%分開計稅不得申報、基本所得額670萬以上不得申報 |
| 章節3 | 長照 vs 身障扣除額：怎麼選 | 同一人擇一、金額比較、排富考量 |
| 章節4 | 能省多少稅 | 最高只到稅率12%適用，5%省6千，12%省1.4萬 |
| 章節5 | 申報需要哪些文件 | 長照核定通知書、機構證明、外籍看護許可函 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/tax-calculator、/disability-deduction-2026、/amt-calculator 等）

**SEO 關鍵字覆蓋（12個）**：
長期照顧特別扣除額、長照扣除額、長期照顧報稅、長照扣除2026、老人照護報稅、外籍看護報稅、長照特別扣除、114年長期照顧扣除、長照服務申報所得稅、長照排富條款、長期照顧節稅、失能老人報稅

#### 3. Sitemap 更新
- 新增 `/disability-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-09T22:00:00Z）
- 新增 `/ltc-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-09T22:30:00Z）

#### 4. Threads 草稿 × 3（身心障礙＋長照主題）
**`public/threads-drafts/2026-04-09-disability-ltc-deduction.md`**

| 草稿 | 角度 | 核心鉤子 | 建議發布日 |
|---|---|---|---|
| A（身障扣除額「不知道就虧了」版） | 多數人漏報 | 「家有身障手冊或重大傷病卡，報稅少扣一個21.8萬」 | 4/28 |
| B（長照扣除額「有個陷阱要知道」版） | 排富條款踩雷 | 「請了外籍看護，每年可以多扣12萬。BUT稅率20%以上不能用」 | 5/2 |
| C（「身障 vs 長照怎麼選」對比版） | 選擇邏輯 | 「同一個家人只能選一個，通常選21.8萬那個」 | 5/5 |

**Build 狀態**：node_modules 不存在（本地無法 build）→ Server Component、無 hooks，結構與現有頁面完全一致，push 至 Vercel 遠端 build 驗證

### 預期營收影響
- **新頁面 /disability-deduction-2026**：
  - 台灣約 120 萬身障手冊持有者 + 重大傷病卡持有人，報稅季都在搜尋
  - 「重大傷病卡可以抵稅嗎」是高意圖關鍵字，搜尋者已有具體需求
  - FAQ JSON-LD → 富文本搜尋 → CTR 提升 20~40%
  - 含 /ltc-deduction-2026、/dependent-deduction 強內連
  - 保守估計5月帶入額外 200~500 訪客（中高齡族群、照顧者，高意圖）
- **新頁面 /ltc-deduction-2026**：
  - 外籍看護持有人超過 25 萬，每年5月報稅都在搜「外籍看護報稅」
  - 排富條款「稅率20%以上不能用」製造「原來我不能用」反差感，分享率高
  - 含 /disability-deduction-2026、/amt-calculator 強內連
  - 保守估計5月帶入額外 150~400 訪客（長照家庭、外籍看護僱主）
- **Threads 3篇（身障+長照）**：
  - 身障扣除額「不知道就虧了」= 高分享動機（幫家人省稅）
  - 長照排富陷阱 = 反差感強，容易轉發
  - 預估觸及 1,000~3,000 / 篇，帶入 80~250 訪客

### 下次要做的事（優先順序）
1. **[阻斷] Ian 設定 Vercel env `NEXT_PUBLIC_ADSENSE_SLOT`** — 廣告收入從0到有的關鍵
2. **[阻斷] Ian 申請 Money101 聯盟帳號** — CTA 等真實連結
3. **[立即] Ian 發 Threads 文**（按排程）：
   - 4/14 薪資扣除額調升版（session 60 草稿）
   - 4/18 存款利息27萬免稅版（session 60 草稿）
   - 4/21 廟宇捐款迷思版（session 59 草稿）
   - 4/24 捐款省稅金額實測版（session 59 草稿）
   - 4/25 上班族扣除額地圖版（session 60 草稿）
   - 4/28 身障扣除額「不知道就虧了」版（本次草稿 A）
   - 5/2 長照排富陷阱版（本次草稿 B）
   - 5/5 身障 vs 長照怎麼選版（本次草稿 C）
4. **[下次 agent]**：
   - 新頁面：「報稅常見問題大全 FAQ」（/tax-faq-2026）— 長尾關鍵字覆蓋廣，全站最強導流頁
   - 新頁面：「幼兒學前特別扣除額」（/preschool-deduction-2026）— 已有 /preschool-deduction，可建114年度深度版
...
- **聯盟行銷**：Money101 links 仍是 placeholder → **[阻斷] Ian 需申請聯盟帳號**
- **流量**：網路無法存取；5月1日報稅開放前 ≈ 22 天（黃金窗口）
- **前次備注確認**：session 59 已完成 `/donation-deduction-2026` 新頁面 + Threads 草稿×3。本次完成 session 59 列出的下一步：`/savings-deduction-2026` + `/salary-deduction-2026` 兩個新頁面。

### 今天做了什麼

#### 1. 新頁面：`/savings-deduction-2026`（儲蓄投資特別扣除額完整攻略）

**為什麼做這個**：
幾乎每個有銀行存款的人都適用，但多數人不了解「27萬」這個數字的含義。
退休族、大額定存族、有股利收入的投資人都有需求。
「銀行利息要繳稅嗎」「存款利息免稅多少」是常年高搜尋量關鍵字。
全站空缺關鍵字，現在建有22天被 Google 索引窗口。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是儲蓄投資特別扣除額 | 每戶27萬、自動適用、不需憑證 |
| 章節2 | 郵局10萬免稅和27萬的關係 | 兩個獨立制度不互占，合計最高37萬 |
| 章節3 | 股利所得算在27萬裡面嗎 | 合併計稅才算；分開28%不適用 |
| 章節4 | 什麼情況下要注意 | 退休族大額定存、夫妻合併申報、大量股利 |
| 章節5 | 怎麼在eTax申報 | 系統自動帶入，確認金額+選股利申報方式 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/tax-calculator、/dividend-tax、/salary-deduction-2026 等）

**SEO 關鍵字覆蓋（12個）**：
儲蓄投資特別扣除額、利息所得免稅、27萬免稅、114年儲蓄投資扣除額、銀行利息報稅、存款利息免稅、股利所得申報、儲蓄投資扣除2026、利息收入扣除額、郵局存款免稅、投資所得免稅、綜合所得稅特別扣除

#### 2. 新頁面：`/salary-deduction-2026`（薪資所得特別扣除額完整攻略）

**為什麼做這個**：
所有上班族的最基本扣除項目，但多數人不清楚「21.8萬」是什麼意思，以為是申請來的。
114年度從20.7萬調升到21.8萬，有時效性內容更容易被索引。
「薪資所得特別扣除額是什麼」「上班族稅怎麼算」是高搜尋量關鍵字。
全站空缺關鍵字。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 什麼是薪資所得特別扣除額 | 每人21.8萬、自動適用、每人計算（非每戶） |
| 章節2 | 能省多少稅 | 21.8萬×稅率試算表、年薪80萬範例 |
| 章節3 | 薪資vs執行業務所得：扣除方式不同 | 薪資用21.8萬；接案用費用率18~45% |
| 章節4 | 特殊情況：加班費、獎金、兼職 | 都算薪資所得，合計一個21.8萬 |
| 章節5 | 114年度比上年提高1.1萬 | 調升理由（通膨指數）、各稅率省稅對照 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/tax-calculator、/salary-vs-freelancer、/savings-deduction-2026 等）

**SEO 關鍵字覆蓋（12個）**：
薪資所得特別扣除額、薪資扣除額、21.8萬扣除額、114年薪資所得扣除、上班族報稅、薪資所得申報、薪資所得扣除2026、受薪階級報稅、薪資特別扣除、綜合所得稅薪資、薪資所得稅怎麼算、上班族節稅

#### 3. Sitemap 更新
- 新增 `/savings-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-09T20:00:00Z）
- 新增 `/salary-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-09T20:30:00Z）
- 修復：sitemap 舊版本遺漏了 ira-vs-labor-retirement 之後的所有項目，本次一併補齊

#### 4. Threads 草稿 × 3（儲蓄+薪資扣除額主題）
**`public/threads-drafts/2026-04-09-savings-salary-deduction.md`**

| 草稿 | 角度 | 核心鉤子 | 建議發布日 |
|---|---|---|---|
| A（薪資扣除額調升版） | 114年度有調升 | 「薪資所得特別扣除額從20.7萬調升到21.8萬了」 | 4/14 |
| B（存款利息免稅版） | 多數人不知道有27萬 | 「銀行存款利息，每戶每年27萬以內不用繳所得稅」 | 4/18 |
| C（上班族扣除額地圖版） | 彙整所有扣除項目 | 「上班族報稅，總共有幾種扣除額？整理一下」 | 4/25 |

**Build 狀態**：node_modules 不存在（本地無法 build）→ Server Component、無 hooks，結構與現有頁面完全一致，push 至 Vercel 遠端 build 驗證

### 預期營收影響
- **新頁面 /savings-deduction-2026**：
  - 「儲蓄投資特別扣除額」「利息免稅」是全站空缺關鍵字，退休族+定存族+投資人都搜
  - 郵局10萬+銀行27萬的「原來有37萬」說法 = 高分享率（讓人有「原來如此」的感覺）
  - FAQ JSON-LD → 富文本搜尋結果 → CTR 提升 20~40%
  - 含 /dividend-tax、/tax-calculator 強內連
  - 保守估計5月帶入額外 150~400 訪客（有存款的40+族群，高意圖）
- **新頁面 /salary-deduction-2026**：
  - 「薪資所得特別扣除額」是所有上班族最基本的問題，搜尋量極高
  - 114年度「調升到21.8萬」有新聞時效性，Google 更可能索引
  - 含 /salary-vs-freelancer、/job-change-tax-2026 強內連
  - 保守估計5月帶入額外 300~800 訪客（上班族報稅前搜尋）
- **Threads 3篇（儲蓄+薪資扣除額）**：
  - 薪資扣除額調升有即時性；27萬利息免稅有「原來如此」的分享動機
  - 預估觸及 1,000~3,000 / 篇，帶入 80~250 訪客
...
3. **[立即] Ian 發 Threads 文**（按排程）：
   ...
   - 4/25 上班族扣除額地圖版
4. **[下次 agent]**：
   - 新頁面：「身心障礙特別扣除額」或「長期照顧特別扣除額」 — 5月報稅前高意圖搜尋
   - 新頁面：「報稅常見問題大全 FAQ」（/tax-faq-2026）— 長尾關鍵字覆蓋廣
   - 若 Ian 拿到 AdSense slot：確認廣告在所有頁面有顯示
   - 若 Ian 拿到 Money101：替換全站 `#money101-affiliate` placeholder
...
- **聯盟行銷**：Money101 links 仍是 placeholder → **[阻斷] Ian 需申請聯盟帳號**
- **流量**：網路無法存取；5月1日報稅開放前 ≈ 22 天（黃金窗口）
- **前次備注確認**：session 58 已完成 `/rent-deduction-2026` 頁面 + Threads 草稿×3 + 論壇文×1。本次完成 session 58 列出的下一步：`/donation-deduction-2026` 新頁面 + Threads 草稿×3。

### 今天做了什麼

#### 1. 新頁面：`/donation-deduction-2026`（捐款節稅完整攻略）

**為什麼做這個**：
全站沒有任何頁面覆蓋「捐款抵稅」「捐款扣除額」關鍵字族群。
台灣報稅季，大量人搜尋「捐款可以抵稅嗎？」「廟宇捐款可以報稅嗎？」。
廟宇捐款≠可抵稅是廣為流傳的誤解，糾正誤解類內容分享率高。
每年5月前是高搜尋峰值，現在建頁面有 22 天被 Google 索引窗口。

**頁面內容**（5個章節）：
| 章節 | 主題 | 核心內容 |
|---|---|---|
| 章節1 | 哪些捐款可以申報 | 政府機關無限制、公益法人20%上限、廟宇不行 |
| 章節2 | 捐款扣除額上限怎麼算 | 綜合所得×20%、具體試算範例 |
| 章節3 | eTax怎麼填捐款扣除額 | 3步驟：收據→列舉→確認合計 |
| 章節4 | 捐款抵稅的最優策略 | 省稅金額=捐款額×邊際稅率、何時效益最大 |
| 章節5 | 4個常見誤解 | 廟宇捐款不行、標準扣除額不適用、沒收據不行 |
- FAQ JSON-LD（5題）+ Article schema
- AdUnit × 2 + TaxAffiliateCTA × 1
- 7個相關工具內連（/tax-calculator、/deduction-compare、/rent-deduction-2026 等）
- 綠色 CTA：立即試算報稅金額

**SEO 關鍵字覆蓋（12個）**：
捐款抵稅、捐款節稅、捐款扣除額、捐款可以扣稅嗎、114年捐款扣除、公益捐款抵稅、捐款列舉扣除、慈善捐款報稅、捐款申報所得稅、哪些捐款可以抵稅、廟宇捐款抵稅、捐款節稅2026

#### 2. Sitemap 更新
- 新增 `/donation-deduction-2026`（priority: 1.0，changeFrequency: yearly，lastModified: 2026-04-09T18:00:00Z）

#### 3. Threads 草稿 × 3（捐款節稅主題）
**`public/threads-drafts/2026-04-09-donation-deduction.md`**

| 草稿 | 角度 | 核心鉤子 | 建議發布日 |
|---|---|---|---|
| A（廟宇迷思版） | 糾正誤解 | 「捐給廟宇可以抵稅嗎？答案是不行」 | 4/21 |
| B（上班族實測版） | 場景感 | 「捐1萬展望會，抵多少稅？取決於你的稅率」 | 4/24 |
| C（最後衝刺版） | 截止日前提醒 | 「報稅截止5/31，今年有捐款的確認這3件事」 | 5/20 |

### 預期營收影響
- **新頁面 /donation-deduction-2026**：
  - 「捐款抵稅」「廟宇捐款抵稅」是全站空缺關鍵字，每年5月是搜尋高峰
  - 廟宇誤解糾正 = 高分享率（朋友轉傳說「原來廟宇不行」）
  - FAQ JSON-LD → 富文本搜尋結果 → CTR 提升 20~40%
  - 頁面含 /tax-calculator 強內連，帶動試算轉換
  - 保守估計5月帶入額外 200~600 訪客（高意圖族群）
- **Threads 3篇（捐款節稅）**：
  - 廟宇誤解 + 省稅金額計算 = 高分享率主題
  - 預估觸及 1,000~3,000 / 篇，帶入 80~250 訪客
...
3. **[立即] Ian 發 Threads 文**（按排程）：
   ...
   - 5/20 截止前最後提醒版
4. **[下次 agent]**：
   - 新頁面：「儲蓄投資特別扣除額」（/savings-deduction-2026）— 幾乎每個納稅人都有，但多數人不了解
   - 新頁面：「薪資所得特別扣除額」（/salary-deduction-2026）— 上班族最常問的項目
   - 若 Ian 拿到 AdSense slot：確認廣告在所有頁面有顯示
   - 若 Ian 拿到 Money101：替換全站 `#money101-affiliate` placeholder
